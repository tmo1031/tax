...
export const profileElements = {
  applicant: {
    ...
    spouse: { element: getElement('spouseCheck'), value: () => profile.applicant.attributes.hasSpouse },
    income: {
  ...
  dependent: {
    specified: { element: getElement('dependentSpecified'), value: () => profile.dependent.specified },
    elderlyLt: { element: getElement('dependentElderlyLT'), value: () => profile.dependent.elderlyLt },
    elderly: { element: getElement('dependentElderly'), value: () => profile.dependent.elderly },
    child: { element: getElement('dependentChild'), value: () => profile.dependent.child },
    other: { element: getElement('dependentOther'), value: () => profile.dependent.other },
    disabilityLt: { element: getElement('dependentDisabilityLT'), value: () => profile.dependent.disabilityLt },
    disabilityP: { element: getElement('dependentDisabilityP'), value: () => profile.dependent.disabilityP },
    disabilityO: { element: getElement('dependentDisabilityO'), value: () => profile.dependent.disabilityO },
  },
  estate: {
    house: {
...
export function getHtmlElements(elements: HtmlElements) {
  ...
  const element = profileElements.applicant.birthYear as HtmlElement;
  const newValue = element.element?.value || null;
  console.log('value:', element.value());
  console.log('newValue:', newValue);
  console.log('element:', element);
  updateValue(element, newValue);
  console.log('birthYear:', profile.applicant.year);
  /*
  for (const key in elements) {
    if (elements[key] && typeof elements[key] === 'object') {
      ...
      if ('element' in element && 'value' in element) {
        ...
        console.log('Recursing into nested elements');
